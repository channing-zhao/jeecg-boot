        ...
        <a-row>
          ...
          <a-col :span="12">
            <a-form-item label="科目" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <j-dict-select-tag type="list" v-decorator="['kemu']" :trigger-change="true" dictCode="yclzl" placeholder="请选择科目"/>
            </a-form-item>
          </a-col>
             <a-col :span="12">
            <a-form-item label="功效" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-textarea v-decorator="['effect']" rows="4" placeholder="请输入功效"/>
            </a-form-item>
          </a-col>
            <a-col :span="12">
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/nz/nzSource/add",
          edit: "/nz/nzSource/edit",
          queryById: "/nz/nzSource/queryById"
        }
      }
    },
    computed: {
