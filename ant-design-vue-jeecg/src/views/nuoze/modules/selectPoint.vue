<template>
  <div>
    <div style="overflow: hidden;">
      <section>
        <!--工具条-->
        <a-col :span="24" class="toolbar" style="padding-bottom: 0px;">
          <a-form :inline="true">
            <a-form-item>
              <a-input v-model="inputVal" placeholder="城市名称" @keyup.native="inputChange"
                        style="width: 300px;"></a-input>
            </a-form-item>
            <a-form-item>
              <a-button type="primary" @click="search">获取地理位置</a-button>
            </a-form-item>
            <a-form-item>
              <a-input v-model="latlngCurrent" placeholder="坐标值" style="width: 246px;"></a-input>
            </a-form-item>
          </a-form>
        </a-col>
      </section>
  ...
  export default {
    ...
    methods: {
      loadQQmap() {
        ...
        script.src = "https://map.qq.com/api/js?v=2.exp&key=JWBBZ-W7L3I-KSMGQ-5EXNC-X3ONT-HJFZM&libraries=place&callback=onMapFileLoad";
        //添加标签到dom
